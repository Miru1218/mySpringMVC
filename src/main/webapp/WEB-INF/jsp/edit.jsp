...
<table table width="100%" border="1">
    <form id="EditForm" action="/productlist/editSave">
        ...
        <tr>
            <th>發佈日期</th>
            <td>
                <input class="Wdate" type="text" id="releasedate" name="releasedate" value="${productlist.releasedate}"
                       onFocus="WdatePicker({dateFmt:'yyyMMdd'})"/>
            </td>
            <th>截止日期</th>
            <td>
                <input class="Wdate" type="text" id="deadlinedate" name="deadlinedate"
                       value="${productlist.deadlinedate}" onFocus="WdatePicker({dateFmt:'yyyMMdd'})"/>
            </td>
        </tr>
        <tr>
